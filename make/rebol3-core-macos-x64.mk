...
CFLAGS= -c $(INCLUDES) $(DEFINES) -O2 -Wno-pointer-sign -mmacosx-version-min=10.9  $(USE_FLAGS)
LFLAGS= $(LIBS) $(FRAMEWORKS) -O2 -Wno-pointer-sign -mmacosx-version-min=10.9 -Wl,-stack_size -Wl,0x00400000  $(USE_FLAGS)
...
OBJS = \
	...
	$O/src/os/osx/dev-clipboard.o \
	$O/src/os/osx/sys-clipboard.o \
	$O/src/os/osx/sys-utils.o \
...
$O/src/core/p-clipboard.o: $R/src/core/p-clipboard.c
	$(CC) $R/src/core/p-clipboard.c $(CFLAGS) -o $O/src/core/p-clipboard.o
...
$O/src/os/osx/dev-clipboard.o: $R/src/os/osx/dev-clipboard.c
	$(CC) $R/src/os/osx/dev-clipboard.c $(CFLAGS) -o $O/src/os/osx/dev-clipboard.o

$O/src/os/osx/sys-clipboard.o: $R/src/os/osx/sys-clipboard.m
	$(CC) $R/src/os/osx/sys-clipboard.m $(CFLAGS) -o $O/src/os/osx/sys-clipboard.o

$O/src/os/osx/sys-utils.o: $R/src/os/osx/sys-utils.m
	$(CC) $R/src/os/osx/sys-utils.m $(CFLAGS) -o $O/src/os/osx/sys-utils.o
